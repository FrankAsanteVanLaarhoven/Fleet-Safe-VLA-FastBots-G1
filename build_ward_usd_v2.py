...
print("[build_ward_usd_v2] Booting SimulationContext")
...
print(f"[build_ward_usd_v2] Injecting Core Environment Asset: {HOSPITAL_URL}")
...
print("[build_ward_usd_v2] Pumping application physics ticks")
sim.reset()
for _ in range(50):
    sim.step()

import omni.isaac.core.utils.prims as prim_utils
print("[build_ward_usd_v2] Defining semantic constraint geometry")
...
print(f"[build_ward_usd_v2] Exporting final scene map to {TARGET_PATH}")
stage_utils.save_stage(TARGET_PATH)

simulation_app.close()
print("[build_ward_usd_v2] Routine complete!")
