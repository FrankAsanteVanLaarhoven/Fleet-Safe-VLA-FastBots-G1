-- =====================================================
-- DataMinerAI Complete Database Setup
-- =====================================================
-- This script sets up the complete DataMinerAI database schema
-- for your Supabase project: rwjuwwagiqgmdfmorysk
-- 
-- Run this script in your Supabase SQL Editor to set up
-- the complete DataMinerAI database schema and initial data
-- =====================================================
...
-- Server Configuration for DataMinerAI
...
('DATAMINERAI_SERVER_PORT', '8181', false, 'server_config', 'DataMinerAI main server port'),
('DATAMINERAI_FRONTEND_PORT', '3737', false, 'server_config', 'DataMinerAI frontend port'),
('DATAMINERAI_MCP_PORT', '8051', false, 'server_config', 'DataMinerAI MCP server port');
...
-- SETUP COMPLETE
-- =====================================================
-- Your DataMinerAI database is now fully configured!
-- 
-- Next steps:
